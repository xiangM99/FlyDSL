...
from kernels.moe.moe_gemm_2stage_common_gfx1250 import (
...
def _compile_stage1_mxscale_kernel_impl(
    *,
    ...
    from kernels.gemm.gemm_common_gfx1250 import workgroup_barrier
    ...
    if bool(use_tdm_store):
        from kernels.gemm.gemm_common_gfx1250 import store_acc_vec8_to_lds
    ...
    def moe_mxscale_stage1_single(
        ...
        if const_expr(bool(use_tdm_store)):
            from kernels.gemm.gemm_common_gfx1250 import get_lds_memref
...
def compile_moe_gemm2_ex(*, mode=MoeGemm2Mode.ATOMIC, valid_mask=None, zero_intermediate=True, **kw):
    if mode == MoeGemm2Mode.REDUCE:
        ...
        from kernels.moe.moe_gemm_2stage import _MoeGemm2ReduceWrapper
